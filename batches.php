...
$db = getUipDbInstance();
$select = array('id', 'start', 'end','date_issued');

// If user searches 
if ($search_string) {
    $db->where('start', '%' . $search_string . '%', 'like');
     $db->orWhere('end', '%' . $search_string . '%', 'like');
     $db->orWhere('date_issued', '%' . $search_string . '%', 'like');
}
...
$result = $db->arraybuilder()->paginate("insurance_batches", $page, $select);
...
<div class="row">
     <div class="col-lg-6">
            <h1 class="page-header">Insurance Batches</h1>
        </div>
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
                <a href="add_batch.php"> <button class="btn btn-success">Add new</button></a>
            </div>
        </div>
</div>
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_batch.php?batch_id=<?php echo $row['id']?>&operation=edit" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span></a>

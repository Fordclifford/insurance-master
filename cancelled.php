...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Cancelled Policies</h1>
        </div>
...
<!--   Filter section end-->
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
			...
			<a href=""  class="btn btn-danger delete_btn" data-toggle="modal" data-target="#confirm-delete-<?php echo $row['id'] ?>" style="margin-right: 8px;"><span class="fa fa-check"></span></td>
				</td>
					 ...
					 <div class="modal fade" id="confirm-delete-<?php echo $row['id'] ?>" role="dialog">
					    <div class="modal-dialog">
					      <form action="undodelete.php" method="POST">
					      <!-- Modal content-->
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          ...
						          <p>Are you sure you want to reinstate this policy?</p>
						        </div>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="cancelled.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>

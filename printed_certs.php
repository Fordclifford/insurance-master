...
$db->join("`client_bike_details` e", "e.id = d.motorbike_details_id", "LEFT");
 $db->join("m_client c", "c.id = e.client_id", "LEFT");
   ...
   $select = array('d.id',"d.print_date", 'c.display_name','d.policy_number','d.commence_date','d.period', 'd.due_date','c.mobile_no','c.account_no',"e.`number_plate`","e.Engine","e.Model","e.Others","e.client_id");
            ...
            <?php foreach ($customers as $row) : ?>
                <tr>
	                ...
	                <td><?php echo htmlspecialchars($row['commence_date']) ?> </td>
                        <td><?php echo htmlspecialchars($row['print_date']) ?> </td>
